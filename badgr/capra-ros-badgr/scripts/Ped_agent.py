...
class Pedagent:
    ...
    def reset(self, tf=None, goal=None, orca_test=False):
        ...
        self.controller_walker = self.world.try_spawn_actor(
            self.controller_bp, carla.Transform(), self.vehicle
        )
        ...
        self.cam = self.world.spawn_actor(
            self.camera_bp, car_camera_transform, attach_to=self.controller_walker
        )
        ...
        topdown_camera_transform = carla.Transform(
            carla.Location(x=td_cam_pos.x, y=td_cam_pos.y, z=15),
        ...
        self.collison_sensor = self.world.spawn_actor(
            collison_sensor, car_camera_transform, attach_to=self.controller_walker
        )
        ...
        self.imu = self.world.spawn_actor(
            imu, car_camera_transform, attach_to=self.controller_walker
        )
